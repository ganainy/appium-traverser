#!/usr/bin/env python3
"""
Core CRUD operations for allowed external packages management.

Contains pure business logic for CRUD operations on allowed packages
without any persistence dependencies. This core module can be used by both
CLI and GUI interfaces through the PackagesPersistence protocol.
"""
...
class AllowedPackagesService:
    """Core CRUD operations for managing allowed external packages."""
