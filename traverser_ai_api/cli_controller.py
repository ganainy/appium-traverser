...
class CLIController:
    ...
    def _load_defaults_from_config(self):
        ...
        config_keys = [
            ...
            'WAIT_AFTER_ACTION', 'STABILITY_WAIT', 'APP_LAUNCH_WAIT_TIME', 'VISUAL_SIMILARITY_THRESHOLD',
            'ALLOWED_EXTERNAL_PACKAGES', 'MAX_CONSECUTIVE_AI_FAILURES', 'MAX_CONSECUTIVE_MAP_FAILURES',
            'MAX_CONSECUTIVE_EXEC_FAILURES', 'ENABLE_XML_CONTEXT', 'ENABLE_TRAFFIC_CAPTURE',
            'CLEANUP_DEVICE_PCAP_FILE', 'CONTINUE_EXISTING_RUN'
        ]
