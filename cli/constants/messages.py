...
PRECHECK_STATUS_MESSAGE_NOT_RUNNING_PORT = "Not running on port {port}"
...
START_CMD_ENABLE_VIDEO_RECORDING_HELP = "Enable video recording during crawl"
START_CMD_ENABLE_MOBSF_ANALYSIS_ARG = "--enable-mobsf-analysis"
START_CMD_ENABLE_MOBSF_ANALYSIS_HELP = "Enable automatic MobSF analysis after crawl completes"
...
# ResetConfigCommand
RESET_CONFIG_CMD_NAME = "reset"
RESET_CONFIG_CMD_DESC = "Reset configuration to defaults (clears all stored config, actions, and prompts)"
RESET_CONFIG_CONFIRM_PROMPT = "This will delete all configuration values, focus areas, crawler actions, and prompts. Continue? (yes/no): "
RESET_CONFIG_SUCCESS = "Configuration reset to defaults successfully"
RESET_CONFIG_FAIL = "Failed to reset configuration: {error}"
RESET_CONFIG_CANCELLED = "Reset cancelled"
...
ACTIONS_COMMAND_GROUP_DESC = "Crawler actions management commands"

LIST_ACTIONS_CMD_NAME = "list"
LIST_ACTIONS_CMD_DESC = "List all configured crawler actions"
ACTIONS_SERVICE_NOT_AVAILABLE = "Actions service not available"
FOUND_ACTIONS = "Found {count} actions"

ADD_ACTIONS_CMD_NAME = "add"
ADD_ACTIONS_CMD_DESC = "Add a new crawler action"
ADD_ACTIONS_ARG_NAME = "name"
ADD_ACTIONS_ARG_NAME_METAVAR = "NAME"
ADD_ACTIONS_ARG_NAME_HELP = "Name of the action (e.g., 'click', 'scroll_down')"
ADD_ACTIONS_ARG_DESC = "description"
ADD_ACTIONS_ARG_DESC_METAVAR = "TEXT"
ADD_ACTIONS_ARG_DESC_HELP = "Description of what the action does"
ADD_ACTIONS_SUCCESS = "Successfully added action: {name}"
ADD_ACTIONS_FAIL = "Failed to add action: {name}"

EDIT_ACTIONS_CMD_NAME = "edit"
EDIT_ACTIONS_CMD_DESC = "Edit an existing crawler action"
EDIT_ACTIONS_ARG_ID_OR_NAME = "id_or_name"
EDIT_ACTIONS_ARG_ID_OR_NAME_METAVAR = "ID_OR_NAME"
EDIT_ACTIONS_ARG_ID_OR_NAME_HELP = "ID or name of the action to edit"
EDIT_ACTIONS_ARG_NAME = "name"
EDIT_ACTIONS_ARG_NAME_METAVAR = "NAME"
EDIT_ACTIONS_ARG_NAME_HELP = "New name for the action"
EDIT_ACTIONS_ARG_DESC = "description"
EDIT_ACTIONS_ARG_DESC_METAVAR = "TEXT"
EDIT_ACTIONS_ARG_DESC_HELP = "New description for the action"
EDIT_ACTIONS_ARG_ENABLED = "enabled"
EDIT_ACTIONS_ARG_ENABLED_HELP = "Enable the action"
EDIT_ACTIONS_ARG_DISABLED = "disabled"
EDIT_ACTIONS_ARG_DISABLED_HELP = "Disable the action"
EDIT_ACTIONS_NO_CHANGES = "No changes specified. Use --name, --description, --enabled, or --disabled"
EDIT_ACTIONS_SUCCESS = "Successfully updated action: {id_or_name}"
EDIT_ACTIONS_FAIL = "Failed to update action: {id_or_name}"

REMOVE_ACTIONS_CMD_NAME = "remove"
REMOVE_ACTIONS_CMD_DESC = "Remove a crawler action"
REMOVE_ACTIONS_ARG_ID_OR_NAME = "id_or_name"
REMOVE_ACTIONS_ARG_ID_OR_NAME_METAVAR = "ID_OR_NAME"
REMOVE_ACTIONS_ARG_ID_OR_NAME_HELP = "ID or name of the action to remove"
REMOVE_ACTIONS_SUCCESS = "Successfully removed action: {id_or_name}"
REMOVE_ACTIONS_FAIL = "Failed to remove action: {id_or_name}"

# === Prompts command group ===
PROMPTS_COMMAND_GROUP_DESC = "Crawler prompt templates management commands"

LIST_PROMPTS_CMD_NAME = "list"
LIST_PROMPTS_CMD_DESC = "List all configured crawler prompts"
PROMPTS_SERVICE_NOT_AVAILABLE = "Prompts service not available"
FOUND_PROMPTS = "Found {count} prompts"

ADD_PROMPTS_CMD_NAME = "add"
ADD_PROMPTS_CMD_DESC = "Add a new crawler prompt template"
ADD_PROMPTS_ARG_NAME = "name"
ADD_PROMPTS_ARG_NAME_METAVAR = "NAME"
ADD_PROMPTS_ARG_NAME_HELP = "Name of the prompt (e.g., 'ACTION_DECISION_PROMPT')"
ADD_PROMPTS_ARG_TEMPLATE = "template"
ADD_PROMPTS_ARG_TEMPLATE_METAVAR = "TEXT"
ADD_PROMPTS_ARG_TEMPLATE_HELP = "Prompt template text"
ADD_PROMPTS_SUCCESS = "Successfully added prompt: {name}"
ADD_PROMPTS_FAIL = "Failed to add prompt: {name}"

EDIT_PROMPTS_CMD_NAME = "edit"
EDIT_PROMPTS_CMD_DESC = "Edit an existing crawler prompt template"
EDIT_PROMPTS_ARG_ID_OR_NAME = "id_or_name"
EDIT_PROMPTS_ARG_ID_OR_NAME_METAVAR = "ID_OR_NAME"
EDIT_PROMPTS_ARG_ID_OR_NAME_HELP = "ID or name of the prompt to edit"
EDIT_PROMPTS_ARG_NAME = "name"
EDIT_PROMPTS_ARG_NAME_METAVAR = "NAME"
EDIT_PROMPTS_ARG_NAME_HELP = "New name for the prompt"
EDIT_PROMPTS_ARG_TEMPLATE = "template"
EDIT_PROMPTS_ARG_TEMPLATE_METAVAR = "TEXT"
EDIT_PROMPTS_ARG_TEMPLATE_HELP = "New template text for the prompt"
EDIT_PROMPTS_ARG_ENABLED = "enabled"
EDIT_PROMPTS_ARG_ENABLED_HELP = "Enable the prompt"
EDIT_PROMPTS_ARG_DISABLED = "disabled"
EDIT_PROMPTS_ARG_DISABLED_HELP = "Disable the prompt"
EDIT_PROMPTS_NO_CHANGES = "No changes specified. Use --name, --template, --enabled, or --disabled"
EDIT_PROMPTS_SUCCESS = "Successfully updated prompt: {id_or_name}"
EDIT_PROMPTS_FAIL = "Failed to update prompt: {id_or_name}"

REMOVE_PROMPTS_CMD_NAME = "remove"
REMOVE_PROMPTS_CMD_DESC = "Remove a crawler prompt template"
REMOVE_PROMPTS_ARG_ID_OR_NAME = "id_or_name"
REMOVE_PROMPTS_ARG_ID_OR_NAME_METAVAR = "ID_OR_NAME"
REMOVE_PROMPTS_ARG_ID_OR_NAME_HELP = "ID or name of the prompt to remove"
REMOVE_PROMPTS_SUCCESS = "Successfully removed prompt: {id_or_name}"
REMOVE_PROMPTS_FAIL = "Failed to remove prompt: {id_or_name}"
...
UI_WARNING_MODEL_NO_IMAGE_SUPPORT = "Warning: Selected AI model does not support image inputs. Cannot enable image context."
